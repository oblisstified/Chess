...
def Check(movecount,row,column,Strpiece,StrGrid):
    ...
    if Strpiece[0]=='w':
        ...
        if bkingpos in ValidMove(movecount,row,column,Strpiece,StrGrid):
        ...
        if wkingpos in ValidMove(movecount,row,column,Strpiece,StrGrid):
...
def minimise(movecount,StrGrid):
    ...
    pygame.draw.rect(screen,colour,(5+Row*60,5+Column*60,60,60))
    pygame.display.update()
    return str(row)+str(column)+Strpiece
...
while Endgame:
                            ...
                            if Column1==column and Row1==row and move(movecount)==Strpiece[0]:
                                ...
                                if var in ValidMove(movecount,row,column,Strpiece,StrGrid):
                                    if Strpiece[0]==wob:
                                        ...
                                        pygame.display.update()
                                        Check(movecount,Row1,Column1,Strpiece,StrGrid)
                                        movecount+=1
                                        '''
    ...
    if movecount%2==1:
        ...
        #maximise()
        #minimise()
        coord= minimise(movecount,StrGrid)
        Check(movecount,int(coord[0]),int(coord[1]),coord[2],StrGrid)   
        movecount+=1
