...
def maximise(TempGrid,point,movecount):
            ...
            if TempGrid[Column][Row][0]=='w':
                ...
                if len(array)!=0:
                    for i in array:
                        ...
                        elif TempGrid[column][row]=='empty':
                            if 0>highest:
                                highest=0
                                Highest=str(Row)+str(Column)+str(row)+str(column)
    ...
    row=int(Highest[2])
    column=int(Highest[3])
    Strpiece=TempGrid[Column][Row] 
    Temp=TempGrid[column][row]
    TempGrid[column][row]=Strpiece
    TempGrid[Column][Row]='empty'
    movecount+=1

    anotherpoint=Anotherminimise(TempGrid,movecount)
    ...
    return point-highest+anotherpoint
    

def Anotherminimise(TempGrid,movecount):
    highest=-10
    ...
    lastpoint=AnotherMaximise(TempGrid)
    
    TempGrid[Column][Row]=Strpiece
    TempGrid[column][row]=Temp
    movecount-=1

    return highest-lastpoint



def AnotherMaximise(TempGrid):
    highest=0
